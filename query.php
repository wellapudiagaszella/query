...
<div class="w3-padding-large" id="main">
  ...
  <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    <h2 class="w3-text-light-grey">Cari Query</h2>
...
<input type=submit value="Cari Query">
</form>


 <div class="w3-content w3-justify w3-text-grey w3-padding-64" id="about">
    <h2 class="w3-text-light-grey">Cari QueryTF</h2>
    <hr style="width:100px" class="w3-opacity">
...
Keyword : <br><br>
<input type="text" name="keyword"><br><br>
<input type=submit value="Cari QueryTF">
</form>
